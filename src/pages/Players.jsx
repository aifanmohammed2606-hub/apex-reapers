...
function PlayerCard({ player, onEdit, onDelete, onToggle }) {
  return (
    ...
    <div className="space-y-5 animate-fadeIn">
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          action={!search && <button onClick={() => setModal('add')} className="btn-primary mx-auto"><Plus size={16} /> Add Player</button>}
        />
      ) : (
